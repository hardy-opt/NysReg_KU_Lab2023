...
%     addpath('/home/hardik/data/')
   ...
   % addpath('/data/Datasets/'); % Dataset repository
    ...
    method = {'RSN', 'NGD','NGD1','NGD2', 'Nystrom_GD', 'Nystrom_GDLM','Nystrom_GD1', 'Nystrom_GDLM1','Nystrom_GD2', 'Nystrom_GDLM2' };
    ...
    for s=1:NUM_RUN
        for reg= [ 1e-5]
            for step = 0.0001%[0.1 0.01 0.001] %0.001
